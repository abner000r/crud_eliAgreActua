...
class ReservacionController extends BaseController
{
    ...
    public function modificarReservacion(){
        $datos=[
            'reservacion_id'=>$this->request->getVar('txtReservarId'),
            'fecha'=>$this->request->getVar('txtFecha'),
         ...
         // print_r($datos);
         $reservar = new ReservacionModel();
         $reservar->update($datos['reservacion_id'], $datos);
         return redirect()->route()('reservacion_id');  
         }
         public function buscarReservacion($id=null){
            //echo "id o codigo: ".$id;
            $reservar = new ReservacionModel();
           $datos['datos'] =$reservar ->where ('reservacion_id', $id)->first();
           print_r($datos);
           return view('modificar_reservacion',$datos);
